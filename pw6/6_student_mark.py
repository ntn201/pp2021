...
class Class:
    def __init__(self):
        try:
            self.__students = pickle.load(open("students","rb"))
            self.__courses = pickle.load(open("courses","rb"))
        except:
            self.__students = []
            self.__courses = []
